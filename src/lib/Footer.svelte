<script>
  ...
  const socials = [
    { title: 'github', icon: '/icons/github.svg' },
    {
      title: 'linkedin',
    },
    { title: 'twitter' },
...
<footer class="bg-[#100e1b] text-center text-white">
  <a href="/" class="text-white transition hover:text-emerald-300">
    <Icon name="github" />
  </a>
  ...
  <p>© 2022 - present Laxman Desai. All Rights Reserved.</p>
</footer>
